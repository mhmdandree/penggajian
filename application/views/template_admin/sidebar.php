<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/data_susunan') ?>">
          <i class="fas fa-fw fa-lock"></i>
          <span>Susunan Acara Harian</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('admin/data_program') ?>">Data Program</a>
            <a class="collapse-item" href="<?php echo base_url('admin/data_acara') ?>">Data Acara</a>
          </div>
        </div>
      </li>
